...
import { Search, Filter, Download, MoreVertical, Plus, Calendar, User, MapPin, AlertTriangle } from 'lucide-react';
                ...
                <tr key={booking.id} className="hover:bg-gray-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right relative">
                    ...
                    {activeMenu === booking.id && (
                      <div className="absolute right-6 top-10 mt-1 w-36 bg-white rounded-xl shadow-2xl border border-gray-100 py-1.5 z-30 animate-in fade-in zoom-in duration-200 text-left">
                        <button 
                          onClick={() => {
